        ...
        <>
                ...
                <div  className={classes.ComputedValue__border}>
                    <pre lang="css">
                        <code>height: 100px; <span className="next">// => 100px</span></code>
                            ...
                            <div  className={classes.ComputedValue__border}>
                        <pre lang="css">
                            <code>height: 50%; <span className="next">// => 50px<span className="next"> CV = 50%</span></span></code>
                        </pre>
                                <div  className={classes.ComputedValue__border}>
                            <pre lang="css">
                    ...
                    <pre lang="css">
                        ...
                        <pre lang="css">
                            ...
                            <pre lang="css"  className="no-code" style={{'margin-bottom': '0 !important'}}>
                                ...
                                <code>height: inherit;<span className="next"> // => 50px <span className="next"> CV=50px </span></span> </code>
                            </pre>
                                </div>
                    </div>
                </div>
            ...
            <Slide>
                ...
                <div  className={classes.ComputedValue__border}>
                    ...
                    <div className={classes.ComputedValue__border}>
                        <pre lang="css">
                            <code>height: var(--h);<span className="next"> // => 100px <span className="next"> CV=100px </span></span></code>
                        </pre>
                        <div className={classes.ComputedValue__border}>
                            <pre lang="css"  className="no-code" style={{'margin-bottom': '0 !important'}}>
                                <code>--h: 10px;</code>
                                <code>height: inherit;<span className="next"> // => 100px <span className="next"> CV=100px </span></span> </code>
                            </pre>
                        </div>
                    </div>
                </div>
